...
date_split("spy1", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 1) %>%
    group_by(spy1) %>% tally %>% mutate(prop = n / sum(n))

date_split("spy1", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 2) %>%
    group_by(spy1) %>% tally %>% mutate(prop = n / sum(n))

date_split("spy1", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 3) %>%
    group_by(spy1) %>% tally %>% mutate(prop = n / sum(n))

date_split("spy1", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 4) %>%
    group_by(spy1) %>% tally %>% mutate(prop = n / sum(n))

date_split("spy1", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 5) %>%
    group_by(spy1) %>% tally %>% mutate(prop = n / sum(n))
...
date_split("elsidron2", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1", "chimp"), mindp = 1) %>%
    group_by(elsidron2) %>% tally %>% mutate(prop = n / sum(n))

date_split("elsidron2", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 2) %>%
    group_by(elsidron2) %>% tally %>% mutate(prop = n / sum(n))

date_split("elsidron2", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 3) %>%
    group_by(elsidron2) %>% tally %>% mutate(prop = n / sum(n))

date_split("elsidron2", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 4) %>%
    group_by(elsidron2) %>% tally %>% mutate(prop = n / sum(n))

date_split("elsidron2", "mez2", highcov_nodmg, c("a00", "S_Ju_hoan_North_1"), mindp = 5) %>%
    group_by(elsidron2) %>% tally %>% mutate(prop = n / sum(n))
