...
pop_params = {
    "chimp": {"id": 0, "Ne": Ne_scale * 10000, "t_sample": 1 * [0], "t_split" : args.split_chimp},
    "arch": {"id": 1, "Ne": Ne_scale * args.Ne_arch, "t_sample": args.arch_ages, "t_split": args.split_arch},
    "afr": {"id": 2, "Ne": Ne_scale * args.Ne_afr, "t_sample": args.nafr * [0]},
    "eur": {"id": 3, "Ne": Ne_scale * args.Ne_nonafr, "t_sample": args.ui_age + args.neur * [0], "t_split": args.split_afr},
}
