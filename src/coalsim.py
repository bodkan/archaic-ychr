...
parser.add_argument("--emh-ages", nargs="+", type=int, help="Ages of EMH samples [years BP]")
...
parser.add_argument("--split-arch", type=int, default=600_000)
parser.add_argument("--split-eur", type=int, default=70_000)
...
args = parser.parse_args("--debug --arch-ages 130000 50000 --emh-ages 45000 45000 45000 --neur 5 --nafr 5 --output out.tsv".split())
...
pop_params = {
    ...
    "eur": {"id": 3, "Ne": args.Ne_nonafr, "t_sample": args.emh_ages + args.neur * [0], "t_split": args.split_eur},
