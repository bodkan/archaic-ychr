...
fix_name <- function(name, coverage = FALSE) {
  new_name <- case_when(
    ...
    name == "den4_deam" ~ "Denisova 4 (deam.)",
    name == "den8_deam" ~ "Denisova 4 (deam.)",
    name == "den_merged_deam" ~ "Denisova 4 (merged, deam.)",
    name == "spy1_deam" ~ "Spy 94a (deam.)",
    name == "mez2_deam" ~ "Mezmaiskaya 2 (deam.)",
    name == "spy1" ~ "Spy 94a",
